...
public class GUI_Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("GUI_Content");
        jMenu2.add(jMenuItem1);

        jMenuItem2.setText("GUI_Movie");
        jMenu2.add(jMenuItem2);

        jMenuItem3.setText("GUI_UserPremium");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        GUI_Content tk = new   GUI_Content (); 
        tk.show();
    }                                          

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
        GUI_Movie tv = new   GUI_Movie (); 
        tv.show();
    }                                          

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
         GUI_UserPremium tf = new   GUI_UserPremium (); 
         tf.show();             
    }
    /**
