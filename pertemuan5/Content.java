...
public class Content {
    String namaLayanan, daftarKonten, namaPengguna, genre; int hargaLangganan, duration, playContent, addContent,
    subscribe, showLibrary;
    // Constructor untuk layanan streaming
    public Content(String namaLayanan, String daftarKonten, int hargaLangganan) {
        this.namaLayanan = namaLayanan; this.daftarKonten = daftarKonten; this.hargaLangganan = hargaLangganan;
    }
    // Constructor untuk pengguna
    public Content(String namaPengguna, String genre) { this.namaPengguna = namaPengguna;
        this.genre = genre;
    }
    ...
    // Method informasi pengguna 
    public void informasiPengguna() {
        System.out.println("Nama pengguna: " + namaPengguna); System.out.println("Genre  favorit  pengguna:  "  + genre);
    }
    // Method menonton konten (bisa dioverride) 
    ...
    // Overloading method menontonKonten 
    ...
    // Method menambah konten
    public void menambahKonten(int addContent) { this.addContent = addContent;
        System.out.println("Jumlah	konten	baru	yang ditambahkan: " + addContent);
        System.out.println("Layanan	streaming	terus berkembang!");
    }
    // Method langganan layanan
    public void langgananLayanan(int subscribe) { this.subscribe = subscribe;
        System.out.println("Jumlah	pengguna	yang berlangganan: " + subscribe);
        System.out.println("Layanan semakin populer!");
    }
    // Method menampilkan perpustakaan
    public void menampilkanPerpustakaan(int showLibrary) { 
        this.showLibrary = showLibrary; System.out.println("Jumlah konten dalam perpustakaan: " + showLibrary);
    }
    // Main untuk demo
    public static void main(String[] args) {
        Content layanan1 = new Content("Netflix", "Film, Serial, Dokumenter", 150000);
        Content pengguna1 = new Content("Aldo", "Sci-Fi"); Content tontonan1 = new Content(1000);
        layanan1.informasiLayanan(); 
        pengguna1.informasiPengguna(); 
        tontonan1.menontonKonten(); 
        tontonan1.menontonKonten("Stranger Things\"); // Overloaded version");
